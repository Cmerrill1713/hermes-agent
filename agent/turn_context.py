...
def build_api_messages(
    ...
    for idx, msg in enumerate(canonical_messages):
        ...
        # 'reasoning_details' is kept only for OpenRouter (multi-turn reasoning
        # continuity); strict providers (oMLX) reject the extra field with 422.
        if getattr(agent, "provider", None) != "openrouter":
